...
# After calculating confusion matrix
print('Confusion Matrix:', cm)
...
# Print the metrics
print('avg_PD:', (sum(pd_list) / len(pd_list)) if len(pd_list) > 0 else 'No values in pd_list')
print('avg_PF:', (sum(pf_list) / len(pf_list)) if len(pf_list) > 0 else 'No values in pf_list')
print('avg_balance:', (sum(bal_list) / len(bal_list)) if len(bal_list) > 0 else 'No values in bal_list')
print('avg_FIR:', (sum(fir_list) / len(fir_list)) if len(fir_list) > 0 else 'No values in fir_list')
